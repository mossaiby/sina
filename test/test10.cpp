...
class q4_linear: public sina::fem::element_template<2, 4, 8, sina::kernel::geometry_t::quadrilateral, sina::kernel::quadrature_type_t::gauss_legendre, 2>
{
  ...
  q4_linear(const sina::kernel::index_t index, const sina::kernel::node_set<2> &nodes, const sina::kernel::properties &nodal_properties, const sina::kernel::properties &elemental_properties): sina::fem::element_template<2, 4, 8, sina::kernel::geometry_t::quadrilateral, sina::kernel::quadrature_type_t::gauss_legendre, 2>(index, nodes, nodal_properties, elemental_properties)
  {
    // Empty constructor
  }
